...
const MCP_AUTH_TOKEN = import.meta.env.MCP_AUTH_TOKEN;
...
const TOOLS = [
	...
	{
		name: 'update_rows',
		description: 'Update rows in a kead table matching equality filters. Filters are required to avoid accidental full-table updates.',
		inputSchema: {
			type: 'object',
			properties: {
				table: { type: 'string', enum: TABLES },
	...
	{
		name: 'delete_rows',
		description: 'Delete rows from a kead table matching equality filters. Filters are required to avoid accidental full-table deletes.',
		inputSchema: {
			type: 'object',
